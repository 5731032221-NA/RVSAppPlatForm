...
export const getUserList = () => {
  ...
  // axios.get("http://"+(process.env.REACT_APP_host || "localhost")+":80/users").then((res) => {
    ...
    payload: [
      {
        ...
        id: "London",
        email:
          "https://email.sistacafe.com/emails/uploads/summary/email/54688/301386_full1.jpg",
      },
      {
        name: "Dumbledore",
        id: "Madrid",
        email:
          "https://emails.immediate.co.uk/production/volatile/sites/3/2017/10/dumbledore-c475b3b.jpg?quality=90&resize=768,574",
      },
      {
        name: "Hermione",
        id: "Paris",
