module.exports = {
  updatecomputerprinter: async function (accessToken, id, req) {
    return fetch(`http://localhost:8000/apis/computerprinterbyid/${id}`, {
      method: "PUT",
      headers: {
  ...
  updatehardware: async function (accessToken, id, req) {
    return fetch(`http://localhost:8000/apis/registerdhardwarebyid/${id}`, {
      method: "PUT",
      headers: {
        Authorization:  accessToken,
        "Content-Type": "application/json",
  ...
  insertcomputerprinter: async function (accessToken, req) {
    return fetch(`http://localhost:8000/apis/computerprinter`, {
      method: "POST",
      headers: {
        Authorization:  accessToken,
        "Content-Type": "application/json",
    ...
    inserthardware: async function (accessToken, req) {
        return fetch(`http://localhost:8000/apis/registerdhardware`, {
          method: "POST",
          headers: {
            Authorization:  accessToken,
            "Content-Type": "application/json",
    ...
    listcomputerprinter: async function (accessToken, req) {
      return fetch("http://localhost:8000/apis/listcomputerprinter", {
        method: "GET",
        headers: {
          Authorization:  accessToken,
          "Content-Type": "application/json",
    ...
    listregisterdhardware: async function (accessToken, req) {
      return fetch("http://localhost:8000/apis/listregisterdhardware", {
        method: "GET",
        headers: {
          Authorization:  accessToken,
          "Content-Type": "application/json",
